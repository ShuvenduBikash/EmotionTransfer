# Using StarGAN to generate images of each eage categories
import argparse
import os
import numpy as np
import math
...
opt.residual_blocks=6
opt.selected_attrs=['Black_Hair', 'Blond_Hair', 'Brown_Hair', 'Male', 'Young']
opt.n_critic=5
"""
...
def sample_images(batches_done):
    ...
    for i in range(10):
        ...
        labels = Variable(torch.eye(c_dim,c_dim).type(Tensor))
